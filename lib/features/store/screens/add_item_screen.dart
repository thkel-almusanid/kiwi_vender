...
class _AddItemScreenState extends State<AddItemScreen>
  ...
  final isPharmacy = Get.find<ProfileController>()
          .profileModel!
          .stores![0]
          .module!
          .moduleType ==
      'pharmacy';
  final isEcommerce = Get.find<ProfileController>()
          .profileModel!
          .stores![0]
          .module!
          .moduleType ==
      'ecommerce';
  final isGrocery = Get.find<ProfileController>()
          .profileModel!
          .stores![0]
          .module!
          .moduleType ==
      'grocery';
  final isFood =
      Get.find<SplashController>().getStoreModuleConfig().newVariation!;
  ...
  void initState() {
    ...
    Get.find<StoreController>().initItemData(
        item: widget.item,
        isFood: isFood,
        isGrocery: isGrocery,
    ...
    if (_update) {
      ...
      if (_item.isPrescriptionRequired == 1) {
        Get.find<StoreController>()
            .togglePrescriptionRequired(willUpdate: false);
      }
          ...
          return GetBuilder<StoreController>(builder: (storeController) {
            ...
            if (categoryController.categoryList != null) {
              for (int i = 0;
                  ...
                  i++) {
                categoryList.add(DropdownItem<int>(
                    value: i,
                    child: SizedBox(
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
            ...
            if (categoryController.subCategoryList != null) {
              for (int i = 0;
                  ...
                  i++) {
                subCategoryList.add(DropdownItem<int>(
                    value: i,
                    child: SizedBox(
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child:
                            Text(categoryController.subCategoryList![i].name!),
                      ),
                    )));
              }
            }
            ...
            if (storeController.suitableTagList != null) {
              for (int i = 0;
                  ...
                  i++) {
                suitableTagList.add(DropdownItem<int>(
                    value: i,
                    child: SizedBox(
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
            ...
            if (storeController.brandList != null) {
              for (int i = 0; i < storeController.brandList!.length; i++) {
                brandList.add(DropdownItem<int>(
                    value: i,
                    child: SizedBox(
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
            ...
            for (int i = 0; i < storeController.discountTypeList.length; i++) {
              discountTypeList.add(DropdownItem<int>(
                  value: i,
                  child: SizedBox(
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
            ...
            if (storeController.allergicIngredientsSuggestionList != null) {
              for (int index = 0;
                  index <
                      storeController.allergicIngredientsSuggestionList!.length;
                  index++) {
            ...
            if (storeController.genericNameSuggestionList != null) {
              for (int index = 0;
                  index < storeController.genericNameSuggestionList!.length;
                  index++) {
            ...
            return (storeController.attributeList != null &&
                    categoryController.categoryList !=
                        null /*&& (widget.item != null ? categoryController.subCategoryList != null : true)*/)
                ? Column(children: [
                    Expanded(
                          ...
                          children: [
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    SizedBox(
                                      ...
                                      child: TabBar(
                                        ...
                                        unselectedLabelStyle:
                                            cairoRegular.copyWith(
                                                color: Theme.of(context)
                                                    .disabledColor,
                                                fontSize:
                                                    Dimensions.fontSizeSmall),
                                        labelStyle: cairoBold.copyWith(
                                            fontSize:
                                                Dimensions.fontSizeDefault,
                                            color:
                                                Theme.of(context).primaryColor),
                                        labelPadding: const EdgeInsets.only(
                                            right: Dimensions.radiusDefault),
                                        isScrollable: true,
                                    ...
                                    CustomTextFieldWidget(
                                      hintText: 'name'.tr,
                                      labelText: 'name'.tr,
                                      controller: _nameControllerList[
                                          _tabController!.index],
                                      capitalization: TextCapitalization.words,
                                      focusNode:
                                          _nameFocusList[_tabController!.index],
                                      nextFocus: _tabController!.index !=
                                              _languageList!.length - 1
                                          ? _descriptionFocusList[
                                              _tabController!.index]
                                    ...
                                    CustomTextFieldWidget(
                                      ...
                                      controller: _descriptionControllerList[
                                          _tabController!.index],
                                      focusNode: _descriptionFocusList[
                                          _tabController!.index],
                                      capitalization:
                                          TextCapitalization.sentences,
                                      maxLines: 3,
                                      inputAction: _tabController!.index !=
                                              _languageList.length - 1
                                  ...
                                  children: [
                                              ...
                                              Expanded(
                                                child: Autocomplete<int>(
                                                  ...
                                                  optionsViewBuilder: (context,
                                                      ...
                                                      options) {
                                                    List<int> result = TypeConverter
                                                        .convertIntoListOfInteger(
                                                            options.toString());
                                                        ...
                                                        decoration:
                                                          ...
                                                          hintStyle: cairoRegular.copyWith(
                                                              ...
                                                              color: Theme.of(
                                                                      context)
                                                                  .disabledColor),
                                                          labelStyle: cairoRegular.copyWith(
                                                              fontSize: Dimensions
                                                                  .fontSizeLarge,
                                                              color: Theme.of(
                                                                      context)
                                                          ...
                                                          suffixIcon:
                                                              CustomToolTip(
                                                            message:
                                                                'specify_the_medicine_active_ingredient_that_makes_it_work'
                                                                    .tr,
                                                            preferredDirection:
                                                                AxisDirection
                                                                    .up,
                                                      ...
                                                      child: TextField(
                                                        ...
                                                        decoration:
                                                          ...
                                                          suffixIcon:
                                                              CustomToolTip(
                                                            message:
                                                                'specify_the_ingredients_of_the_item_which_can_make_a_reaction_as_an_allergen'
                                                                    .tr,
                                                            preferredDirection:
                                                                AxisDirection
                                                                    .up,
                                              ...
                                              Expanded(
                                                child: Row(children: [
                                                  Radio(
                                                    value: 'veg',
                                                    groupValue:
                                                        storeController.isVeg
                                                            ? 'veg'
                                                            : 'non_veg',
                                                    onChanged: (String?
                                                            value) =>
                                                        storeController.setVeg(
                                                            value == 'veg',
                                                            true),
                                                    fillColor:
                                    ...
                                    SizedBox(
                                        height: (_module.vegNonVeg! &&
                                            ...
                                            ? Dimensions.paddingSizeExtraLarge
                                            : 0),
                                    (isFood || isGrocery) && storeHalalActive
                                        ? LabelWidget(
                                                  ...
                                                  children: List.generate(
                                                    ...
                                                    final vatTaxName =
                                                        storeController
                                                                .selectedVatTaxNameList[
                                                            index];
                                                    final vatTaxId = storeController
                                                            .selectedVatTaxIdList[
                                                        index];
                                                    final taxRate = storeController
                                                            .selectedTaxRateList[
                                                        index];
                                                    return Padding(
                                                      padding: const EdgeInsets
                            ...
                            Get.find<SplashController>()
                                ...
                                : AttributeViewWidget(
                                    ...
                                    product: widget.item),
                            _module.addOn!
                                ? Text('addons'.tr, style: cairoBold)
                                : const SizedBox(),
                            SizedBox(
                            ...
                            _module.itemAvailableTime!
                                ? Text('availability'.tr, style: cairoBold)
                                : const SizedBox(),
                            SizedBox(
                                          ...
                                          index ==
                                              (storeController
                                                  ...
                                                  storeController
                                                      .savedImages.length))
                                      ? null
                                      : storeController.rawImages[index -
                                          storeController.savedImages.length];
                                  if (index ==
                                      (storeController.rawImages.length +
                                          storeController.savedImages.length)) {
                        ...
                        onPressed: () {
                          ...
                          if (defaultDataNull) {
                            ...
                            _item.isPrescriptionRequired =
                                storeController.isPrescriptionRequired ? 1 : 0;
